...
# Ad Copy Regenerator - Mac Setup Script (No Sudo Required)
# This script sets up the environment without requiring administrator privileges

set -e  # Exit on any error

echo "🚀 Setting up Ad Copy Regenerator on macOS (No Sudo Required)"
echo "============================================================="
...
if command -v tesseract &> /dev/null; then
    ...
    print_warning "Tesseract OCR not found. Installing via Homebrew..."
...
echo "  2. Test with: python3 test_system.py"
echo ""
